...
#TODOsteffenmerge		self.widget.findChild(name="headline").text = unicode(self.instance.settlement.get_component(NamedComponent).name)
#TODOsteffenmerge		self.helptext = _("Warehouse overview")

#TODOsteffenmerge	def refresh(self):
#TODOsteffenmerge		settlement = self.instance.settlement
#TODOsteffenmerge		self.widget.findChild(name="headline").text = unicode(settlement.get_component(NamedComponent).name)

#TODOsteffenmerge		selling_inventory = self.widget.findChild(name='selling_inventory')
#TODOsteffenmerge		selling_inventory.init(self.instance.session.db, settlement.get_component(StorageComponent).inventory, settlement.get_component(TradePostComponent).sell_list, True)

#TODOsteffenmerge		buying_inventory = self.widget.findChild(name='buying_inventory')
#TODOsteffenmerge		buying_inventory.init(self.instance.session.db, settlement.get_component(StorageComponent).inventory, settlement.get_component(TradePostComponent).buy_list, False)

#TODOsteffenmerge		super(EnemyWarehouseOverviewTab, self).refresh()
